...
public class BlockShape {
    ...
    private void setupDimensions() {
      ...
      /* if( this.block.getGenusName().equals("serial_port_out")){
        ...
        if(block.getGenusName().equals("serial_pin_in")||block.getGenusName().equals("serial_port_in")||block.getGenusName().equals("serial_port_out")||block.getGenusName().equals("serial_pin_out")
        		||block.getGenusName().equals("Input/Output")){
       	 topLeftCorner = new Point2D.Double(15 + initX,  + initY);
            topRightCorner = new Point2D.Double(determineBlockWidth()+15 + initX, initY);
            botLeftCorner = new Point2D.Double(initX, initY+ determineBlockHeight());
            botRightCorner = new Point2D.Double(initX + determineBlockWidth(),initY+ determineBlockHeight());
            return;
